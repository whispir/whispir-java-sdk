...
public class MessageHelperImplTest extends WhispirSDKTest {
  ...
  public void testBadRecipient() throws WhispirSDKException {
    WhispirResponse response = whispirSDK.sendMessage(TEST_WORKSPACE_ID,"1", TEST_MESSAGE_SUBJECT,
        TEST_MESSAGE_BODY);
  ...
  public void testBadSubject() throws WhispirSDKException {
    WhispirResponse response = whispirSDK.sendMessage(TEST_WORKSPACE_ID,TEST_RECIPIENT, "",
        TEST_MESSAGE_BODY);
